      ...
      <div className="container-custom px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl text-secondary-foreground mb-6">
              Careers at<br />
          ...
          <div className="space-y-6">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="flex gap-4 p-6 bg-secondary-foreground/5 border border-secondary-foreground/10 rounded-xl hover:border-primary/50 transition-colors group"
              >
                ...
                <div>
                  <h3 className="font-display text-xl mb-1 text-secondary-foreground">{benefit.title}</h3>
